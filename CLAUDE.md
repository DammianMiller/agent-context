...
### Hot Spots
Frequently modified files (hot spots): package.json (35 changes), package-lock.json (26 changes), .beads/issues.jsonl (25 changes), templates/CLAUDE.template.md (20 changes), CLAUDE.md (11 changes), src/generators/claude-md.ts (11 changes), README.md (9 changes), src/bin/cli.ts (8 changes), src/cli/init.ts (8 changes), src/cli/memory.ts (7 changes). These files may need extra attention during changes.
